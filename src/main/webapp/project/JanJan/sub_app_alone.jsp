        ...
        <header>
            ...
            <div class="inner">
                <div class="gnb">
                    ...
                    <div class="gnbR">
                        <ul>
                            <li><a href="login2.jsp`">로그인/회원가입</a></li>
        ...
        <div class="inner">
            ...
            <form action="success.jsp" method="POST">
                ...
                <div class = "box01">
                    ...
                    <div>
                        <img class = "sub_img" src = "./img/alone.png"/>
                    </div>
                    <div><br>
					    <input type="hidden" name="pname" value="나홀로 잔잔박스">
					    <h2 class="name">나홀로 잔잔박스</h2>
                        <div>
                        	<input type="hidden" name="cnt" value="1개">
                            <h2 class = "cnt" name = "cnt">1개</h2>
                            <input type="hidden" name="price" value="32,000원">
                            <h2 class = "pay" name = "price">32,000원/월</h2>
                        </div>
                    </div>
                    <div class = "day">
                        <div>
